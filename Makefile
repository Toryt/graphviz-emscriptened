...
$(SRCDIR)/lib/common/libcommon-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/circogen/libcircogen-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/neatogen/libneatogen-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/twopigen/libtwopigen-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/patchwork/libpatchwork-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/osage/libosage-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/sparse/libsparse-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/pack/libpack-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/cgraph/libcgraph-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/fdpgen/libfdpgen-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/label/liblabel-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/gvc/libgvc-em.bc: $(SRCDIR)
...
$(SRCDIR)/lib/pathplan/libpathplan-em.bc: $(SRCDIR)
...
$(SRCDIR)/plugin/core/libgvplugin_core-em.bc: $(SRCDIR)
...
$(SRCDIR)/plugin/dot_layout/libgvplugin_dot_layout-em.bc: $(SRCDIR)
...
$(SRCDIR)/plugin/neato_layout/libgvplugin_neato_layout-em.bc: $(SRCDIR)
...
$(SRCDIR): | graphviz-2.36.0.tar.gz
	...
	@patch --input=../../../core.patch --directory=$(SRCDIR)/plugin/core
